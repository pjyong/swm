...
use Cheyoo\System\Exception\ContainerValueNotFoundException;
use Cheyoo\System\Exception\ContainerException as CyContainerException;
    ...
    public function get($id)
    {
        ...
        try {
            ...
            if ($this->exceptionThrownByContainer($exception)) {
                throw new CyContainerException(
