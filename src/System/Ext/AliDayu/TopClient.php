...
class TopClient
{
	public $appkey = "23517833";

	public $secretKey = "fc1b905abafd2e0a537831207ce2d3c8";
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
	{
		...
		Yii::log(json_encode($logData),'error','AliDayu');
	}
	...
	public function execute($request, $session = null,$bestUrl = null)
	{
		...
		{
			Yii::log(json_encode($resp),'error','AliDayu');
		}
		return $respObject;
	}
